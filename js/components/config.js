...
export function openConfigModal() {
  ...
  const body = `
    ...
    <div class="form-group"><label>Checklist de emergencia (uno por lÃ­nea)</label><textarea id="cfg-checklist" rows="5">${config.emergencyChecklist.join('\n')}</textarea></div>`;
  ...
  showModal('ConfiguraciÃ³n', body, footer);
