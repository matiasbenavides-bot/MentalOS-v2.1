...
New-Item -ItemType Directory -Force -Path js/components | Out-Null
...
'@ | Set-Content -Encoding utf8 js/storage.js
...
'@ | Set-Content -Encoding utf8 js/state.js
...
'@ | Set-Content -Encoding utf8 js/ui.js
...
'@ | Set-Content -Encoding utf8 js/components/home.js
...
'@ | Set-Content -Encoding utf8 js/components/development.js
...
'@ | Set-Content -Encoding utf8 js/components/studies.js
...
'@ | Set-Content -Encoding utf8 js/components/training.js
...
'@ | Set-Content -Encoding utf8 js/components/analysis.js
...
'@ | Set-Content -Encoding utf8 js/components/emergency.js
...
'@ | Set-Content -Encoding utf8 js/components/config.js

Write-Host "Todos los componentes JS creados correctamente." -ForegroundColor Green