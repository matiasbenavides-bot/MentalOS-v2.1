#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Genera todos los componentes JS de MentalOS con codificación UTF-8 correcta."""
...
# ==================== js/storage.js ====================
archivos["js/storage.js"] = r"""const PREFIX = 'mentalo_';
...
# ==================== js/state.js ====================
archivos["js/state.js"] = r"""import { Storage } from './storage.js';
...
# ==================== js/ui.js ====================
archivos["js/ui.js"] = r"""export function showModal(title, bodyHtml, footerHtml = '') {
...
# ==================== js/app.js ====================
archivos["js/app.js"] = r"""import { Storage } from './storage.js';
...
archivos["js/components/home.js"] = r"""import { Storage } from '../storage.js';
...
archivos["js/components/development.js"] = r"""import { renderStudies } from './studies.js';
...
# ==================== js/components/studies.js ====================
archivos["js/components/studies.js"] = r"""import { Storage } from '../storage.js';
...
archivos["js/components/training.js"] = r"""import { Storage } from '../storage.js';
import { todayStr, calculateBasal, spendCredit } from '../state.js';
import { showModal, closeModal, showToast } from '../ui.js';
...
archivos["js/components/analysis.js"] = r"""import { Storage } from '../storage.js';
import { calculateBasal } from '../state.js';
let chart;
...
archivos["js/components/emergency.js"] = r"""import { Storage } from '../storage.js';
...
archivos["js/components/config.js"] = r"""import { Storage } from '../storage.js';
import { showModal, closeModal, showToast } from '../ui.js';
...
print("\n✅ Todos los componentes JS generados con codificación UTF-8 correcta.")